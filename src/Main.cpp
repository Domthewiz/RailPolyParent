...
tBranch(0x02849E54, ParentMovementMgr_fetchPath, tk::BranchType::b); // ParentMovementMgr::fetchPath()
...
tBranch(0x0287ACD0, PathControlledActor_getController, tk::BranchType::b); // PathControlledActor::getController()